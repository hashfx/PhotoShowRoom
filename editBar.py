...
class EditBar(Frame):
    ...
    def __init__(self, master=None):
        ...
        self.new_button = Button(self, text="New", fg="black", bg="#00CCCC", font="comicsansms 12 bold")
        self.save_button = Button(self, text="Save", fg="black", bg="#00CCCC", font="comicsansms 12 bold")
        self.save_as_button = Button(self, text="Save As", fg="black", bg="#00CCCC", font="comicsansms 12 bold")
        self.draw_button = Button(self, text="Draw", fg="black", bg="#00CCCC", font="comicsansms 12 bold")
        self.crop_button = Button(self, text="Crop", fg="black", bg="#00CCCC", font="comicsansms 12 bold")
        self.filter_button = Button(self, text="Filter", fg="black", bg="#00CCCC", font="comicsansms 12 bold")
        self.adjust_button = Button(self, text="Adjust", fg="black", bg="#00CCCC", font="comicsansms 12 bold")
        self.clear_button = Button(self, text="Clear", fg="black", bg="#00CCCC", font="comicsansms 12 bold")
        ...
        self.save_as_button.pack(side=LEFT, padx=10)
